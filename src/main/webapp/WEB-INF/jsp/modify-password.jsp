...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding: 30px; min-width: 1000px;">
        <div class="layui-col-md2 layui-col-md-offset2 login" style="width: 708px;">
            <form action="<c:url value="/modifyPassword"/>" method="post" class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="password" name="oldPassword" required lay-verify="required|password"
                               class="layui-input"
                               placeholder="原始密码"/>
                    </div>
                </div>
